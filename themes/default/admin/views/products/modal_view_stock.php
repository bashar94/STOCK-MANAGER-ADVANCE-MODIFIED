...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
     ...
     <div class="col-xs-12">
        <div class="row">
            <div class="col-xs-12">
                <?php if (!empty($existings)) { ?>
                    <h3 class="bold">All Product Entry</h3>
                    <div class="table-responsive">
                        <table
                        class="table table-bordered table-striped table-condensed dfTable">
                        <thead>
...
$(document).ready(function() {
    ...
    $('.mucha').click(function(event){
        var row_tb = $(this).closest('tr').attr('id');

        $.ajax({
            type: 'get',
            url: '<?= admin_url('products/deleteExisting'); ?>',
            dataType: "json",
            data: {
                id: row_tb
            },
            success: function (data) {
               $('.mucha').parents('.amar#'+row_tb).remove();
           }
        });
