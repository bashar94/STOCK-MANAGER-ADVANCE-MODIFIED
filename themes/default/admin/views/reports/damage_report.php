...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getDamagesReport/?v=1'.$v) ?>',
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    pl += parseInt(aaData[aiDisplay[i]][6]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[6].innerHTML = '<div class="text-right">'+pl+'</div>';
            }
            ...
            {column_number: 3, filter_default_label: "[Brand]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[Origin]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[Product Details]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Damage Report <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/damages"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getDamagesReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getDamagesReport/0/xls/?v=1'.$v)?>";
            return false;
        });
