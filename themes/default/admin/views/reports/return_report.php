...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getReturnsReport/?v=1'.$v) ?>',
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[7].innerHTML = '<div class="text-right">'+pl+'</div>';
            }
            ...
            {column_number: 6, filter_default_label: "[Customer]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Return Report <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/returns"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getReturnsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getReturnsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
